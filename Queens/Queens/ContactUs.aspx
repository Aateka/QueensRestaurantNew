<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactUs.aspx.cs" Inherits="Queens.ContactUs" %>
          ...
          <nav class="rd-navbar rd-navbar-default rd-navbar-transparent" data-lg-auto-height="true" data-md-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-static" data-lg-stick-up="true">
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!--Navbar Brand-->
                <div class="rd-navbar-brand"><a href="home.aspx"></a><h1 style="margin-top: -16px;margin-left: -15px;">
              ...
              <div class="rd-navbar-menu-wrap">
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-mobile-scroll">
                    <!--Navbar Brand Mobile-->
                    <div class="rd-navbar-mobile-brand"><a href="home.aspx"><img style='margin-top: -5px;margin-left: -15px;' width='218' height='32' src='images/logo.png' alt=''/></a></div>
                    ...
                    <ul class="rd-navbar-nav">
                      <li><a href="home.aspx"><span>Home</span></a>
                      </li>
            ...
            <div class="col-md-12">
              <div class="row justify-content-sm-center">
                ...
                <div class="col-sm-12 offset-top-66 col-xl-3 order-xl-1 offset-xl-top-0 order-lg-3">
                  <!-- Footer brand-->
                  <div class="footer-brand"><a href="home.aspx"></a><h1 style="margin-top: -16px;margin-left: 0px;" width="218" height="32">
